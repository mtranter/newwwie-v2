declare namespace Queries {
  ...
  type MEETUPS = {
    readonly keywordSearch: Maybe<MEETUPS_KeywordSearchResult>;
  };

  type MEETUPS_keywordSearchArgs = {
    filter: InputMaybe<MEETUPS_KeywordSearchFilter>;
    sort: InputMaybe<MEETUPS_KeywordSearchSort>;
  };

  type MEETUPS_Event = {
    readonly dateTime: Maybe<Scalars["String"]>;
    readonly description: Maybe<Scalars["String"]>;
    readonly duration: Maybe<Scalars["String"]>;
    readonly eventUrl: Maybe<Scalars["String"]>;
    readonly going: Maybe<Scalars["Int"]>;
    readonly group: Maybe<MEETUPS_Group>;
    readonly imageUrl: Maybe<Scalars["String"]>;
    readonly maxTickets: Maybe<Scalars["Int"]>;
    readonly title: Maybe<Scalars["String"]>;
    readonly venue: Maybe<MEETUPS_Venue>;
  };

  type MEETUPS_Group = {
    readonly groupPhoto: Maybe<MEETUPS_Photo>;
    readonly logo: Maybe<MEETUPS_Photo>;
    readonly name: Maybe<Scalars["String"]>;
    readonly urlname: Maybe<Scalars["String"]>;
  };

  type MEETUPS_KeywordSearchEdge = {
    readonly node: Maybe<MEETUPS_KeywordSearchNode>;
  };

  type MEETUPS_KeywordSearchFilter = {
    ...
    readonly source: InputMaybe<MEETUPS_Source>;
    readonly topicCategoryId: InputMaybe<Scalars["Int"]>;
  };

  type MEETUPS_KeywordSearchNode = {
    readonly result: Maybe<MEETUPS_SearchResult>;
  };

  type MEETUPS_KeywordSearchResult = {
    readonly edges: Maybe<ReadonlyArray<Maybe<MEETUPS_KeywordSearchEdge>>>;
  };

  type MEETUPS_KeywordSearchSort = {
    readonly sortField: InputMaybe<MEETUPS_SortField>;
    readonly sortOrder: InputMaybe<MEETUPS_SortOrder>;
  };
  ...
  type MEETUPS_SearchResult = MEETUPS_Event | MEETUPS_Group;

  type MEETUPS_SortField = "DATETIME";

  type MEETUPS_SortOrder = "ASC" | "DESC";

  type MEETUPS_Source = "EVENTS";
        ...
        readonly node: {
          readonly result:
            | {
                ...
                readonly maxTickets: number | null;
